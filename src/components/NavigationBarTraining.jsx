...
export default function NavigationBarTraining(props) {
  const {
        ...
        <div className="container">
          ...
          <nav className="navHeader">
            <ul className="listNavHeader">
              ...
              <li className="navItem"><Link to="/supplement" style={{ color: 'inherit', textDecoration: 'inherit' }}>{navTitle2}</Link></li>
              <li className="navItem"><Link to="/tremenuApp" style={{ color: 'inherit', textDecoration: 'inherit' }}>{navTitle3}</Link></li>
...
NavigationBarTraining.propTypes = {
